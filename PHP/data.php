...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    ...
    <tbody>
        ...
        ?>
            <tr>
                <td p align="center">
                    <a href="edit.php?ni=<?php echo $d['RECEIVED TIMESTAMP']; ?>" title="Edit data ini"> EDIT ||</a>
                    <a href="delete.php?ni=<?php echo $d['RECEIVED TIMESTAMP']; ?>" onclick="return confirm ('Apakah anda yakin ingin menghapus data ini ?');"> HAPUS </a>
                </td>
