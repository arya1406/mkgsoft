        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Penguapan</h1>
                    <p class="mb-4"></p>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <br>
                            <a href="reportadd.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> Data Report</a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <?php
                                include 'PHP/datamaros.php';
                                ?>
                            </div>
                        </div>
                    </div>
