    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="bidangmeteo.html">Meteorologi</a>
                        <a class="collapse-item" href="bidangklimat.html">Klimatologi</a>
                        <a class="collapse-item" href="bidanggeof.html">Geofisika</a>
                    </div>
                </div>
            </li>
            ...
            <div class="sidebar-card">
                ...
                <p class="text-center mb-2"><strong>Admin MKG Soft</strong> memiliki akses lebih banyak dengan fitur
                    yang lebih lengkap, seperti pengeditan database!</p>
                <a class="btn btn-success btn-sm" href="register.html">Jadilah Admin!</a>
            </div>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Adminn</span>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Intensitas Hujan</h1>
                    <p class="mb-4"></p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Daftar data yang tersedia</h6>
                            <br>
                            <a href="./PHP/export.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i>  Download Data</a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <?php
                                include 'PHP/dataexport.php';
                                ?>
                            </div>
                        </div>
                    </div>
